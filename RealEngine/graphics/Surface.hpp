...
public:
	...
	*/
	...
	void clear(const glm::vec4& colour, int index);
	void clear(RE::Colour colour, int index);
...
public:
	...
	*/
	...
	/**
	* Sets texture at given offset as targetted
	* @param index Index of the texture that should be targetted
	*/
	void targetTexture(unsigned int index);
