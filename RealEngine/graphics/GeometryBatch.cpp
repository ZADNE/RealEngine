...
GeometryBatch::GeometryBatch() {
	...
	glEnableVertexAttribArray(ATTR_COLOUR);//Colour
	glVertexAttribPointer(ATTR_COLOUR, 4, GL_UNSIGNED_BYTE, GL_TRUE, sizeof(VertexPOCO), (void*)offsetof(VertexPOCO, colour));
