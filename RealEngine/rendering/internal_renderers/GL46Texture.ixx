 ...
 *  @author    Dubsky Tomas
 */
export module RealEngine.rendering.internal_renderers.GL46Texture;
import glm;
...
public:
    ...
    void setTexels(const TextureID& te, int level, const glm::ivec2& offset, const glm::ivec2& size, const void* raster) const override;
    ...
    void getTexels(const TextureID& te, int level, const glm::ivec2& offset, const glm::ivec2& size, size_t bufSize, void* pixels) const override;
