 ...
 *
 * Texture shape is typically independent of actual size of texture defined by its texels.
 *
 ...
 * There can also be multiple sprites in single shape so these are placed under each other.
*/
struct TextureShape {
    ...
    */
     ...
     *          Pivot is the center point of the subimage for transformations (such as rotation or scale)
    */
     ...
     *          In other words: x = number of subimages in sprite, y = number of sprites
    */
