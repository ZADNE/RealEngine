 ...
 *  @author    Dubsky Tomas
 */
export module RealEngine.rendering.textures.Raster;
import std;
import glm;
import RealEngine.rendering.textures.TextureParameters;
import RealEngine.rendering.textures.TextureFlags;
