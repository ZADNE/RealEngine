 ...
 *  @author    Dubsky Tomas
 */
export module RealEngine.rendering.batches.SpriteBatch;
import std;
import RealEngine.rendering.output.Surface;
import RealEngine.rendering.textures.Texture;
import RealEngine.rendering.vertices.ShaderProgram;
import RealEngine.rendering.batches.Sprite;
import RealEngine.rendering.vertices.VertexArray;
