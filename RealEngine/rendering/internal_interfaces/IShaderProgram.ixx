 ...
 *  @author    Dubsky Tomas
 */
export module RealEngine.rendering.internal_interfaces.IShaderProgram;
import std;
import glm;
export import RealEngine.rendering.internal_interfaces.IBuffer;
export import RealEngine.rendering.textures.TextureUnit;
export import RealEngine.rendering.textures.ImageUnit;
