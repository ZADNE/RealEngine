...
#include <RealEngine/MenuParser.hpp>
...
namespace RGUI {
	...
	public:
		...
		MenuParserError loadMenuFromFile(const std::string& filePath,
			...
			error = MenuParser::parseMenu(filePath, windowSize, spriteBatch, typingHandle, infoMap, buttons, textFields, sliders, plainTexts, closedLists MENU_LM_PASS);
