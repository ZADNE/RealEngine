...
#include <RealEngine/geometric_shapes.hpp>
...
namespace RE {
	...
	public:
		...
		void changeShader(ShaderProgramSeed ss = ShaderProgramSeed::stdGeometry);
	...
	private:
		...
		ShaderProgramPtr m_shader = RE::RM::getShaderProgram(ShaderProgramSeed::stdGeometry);
	};
