...
protected:
    ...
    static const vk::PhysicalDevice& physicalDevice() { return *s_physicalDevice; }
    ...
    static const vk::CommandBuffer& oneTimeSubmitCommandBuffer() { return *s_oneTimeSubmitCommandBuffer; }
    static const vk::DescriptorPool& descriptorPool() { return *s_descriptorPool; }
    static VulkanDeletionQueue& deletionQueue() { return *s_deletionQueue; }
