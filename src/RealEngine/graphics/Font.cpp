...
namespace RE {
	...
	//UNSCALED, UNROTATED
	void Font::add(SpriteBatch& batch, const FontString& s, const glm::vec2& position, int depth, Color tint,
		...
		for (int si = 0; s[si] != 0; si++) {
			...
			if (s[si] == '\n') {
				...
				batch.add(destRect, m_glyphs[gi].uvRect, TextureProxy{ m_texID }, depth, tint);
	...
	void Font::add(SpriteBatch& batch, const FontString& s, const glm::vec2& position, const glm::vec2& scaling,
		int depth, Color tint, HAlign halign/* = HAlign::RIGHT*/, VAlign valign/* = VAlign::FIRST_LINE_ABOVE*/) const {
		glm::vec2 tp = position;
	...
	//SCALED, ROTATED
	void Font::add(SpriteBatch& batch, const FontString& s, const glm::vec2& position, const glm::vec2& scaling,
		int depth, Color tint, const glm::vec2& rots, HAlign halign/* = HAlign::RIGHT*/, VAlign valign/* = VAlign::FIRST_LINE_ABOVE*/) const {
